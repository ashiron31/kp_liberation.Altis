...
opfor_squad_leader = "LOP_BH_Infantry_SL";                        // Squad Leader (Warlord)
...
opfor_machinegunner = "LOP_ISTS_OPF_Infantry_AR_Asst_2";                  // Autorifleman (AR_Asst)
opfor_heavygunner = "LOP_ISTS_OPF_Infantry_AR_2";                         // Heavy Gunner (PKM)
opfor_marksman = "LOP_ISTS_OPF_Infantry_Rifleman_7";                    // Marksman (Lee Enfield)
...
militia_squad = [
    "LOP_ISTS_OPF_Infantry_Rifleman",                                     // Rifleman (AKM)
    "LOP_ISTS_OPF_Infantry_Rifleman",                                     // Rifleman (AKM)
    "LOP_ISTS_OPF_Infantry_Rifleman_5",                                   // Rifleman (AKM-74)
    "LOP_ISTS_OPF_Infantry_Rifleman_5",                                   // Rifleman (AKM-74)
    "LOP_ISTS_OPF_Infantry_AT",                                           // Rifleman (RPG-7)
    "LOP_ISTS_OPF_Infantry_AR_2",                                           // Autorifleman (PKM)
    "LOP_ISTS_OPF_Infantry_Rifleman_7",                                   // Marksman (Lee Enfield)
    "LOP_ISTS_OPF_Infantry_Corpsman",                                     // Medic (Bonesetter)
    "LOP_ISTS_OPF_Infantry_Rifleman",                                     // Rifleman (AKM)
    "LOP_ISTS_OPF_Infantry_Rifleman",                                     // Rifleman (AKM)
    "LOP_ISTS_OPF_Infantry_Rifleman_5",                                   // Rifleman (AKM-74)
    "LOP_ISTS_OPF_Infantry_Rifleman_5",                                   // Rifleman (AKM-74)
    ...
    "LOP_ISTS_OPF_Infantry_Rifleman_7",                                   // Marksman (Lee Enfield)
    "LOP_ISTS_OPF_Infantry_Corpsman",                                     // Medic (Bonesetter)
    "LOP_ISTS_OPF_Infantry_Engineer"                                      // Engineer (Bomber)
];

// Militia vehicles. Lightweight vehicle classnames the game will pick from randomly as sector defenders. Can also be empty for only infantry milita.
militia_vehicles = [
    "LOP_AM_OPF_UAZ_DshKM",                                              // UAZ-3151 (DShKM)
    "rhs_kamaz5350_flatbed_vv",                                              // UAZ-3151 (DShKM)
    "rhs_gaz66o_vv",                                              // UAZ-3151 (DShKM)
    "rhs_zil131_open_vv",                                              // UAZ-3151 (DShKM)
    "rhs_zil131_flatbed_vv",                                              // UAZ-3151 (DShKM)
    "RHS_Ural_Open_VV_01",                                              // UAZ-3151 (DShKM)
    "PRACS_SLA_UAZ_open_DES",                                              // UAZ-3151 (DShKM)
    "PRACS_SLA_UAZ_AT_DES",                                              // UAZ-3151 (DShKM)
    "PRACS_SLA_Tigr"                                              // UAZ-3151 (DShKM)
];
...
opfor_vehicles = [
    ...
    "PRACS_SLA_BMP3",                                          // M10252 (M2)
    "PRACS_SLA_BRDM_HQ",                                        // M1025A2 (Mk19)
    ...
    "LOP_ISTS_OPF_BMP2",                                                // BMP-2
    "LOP_ISTS_OPF_BTR60",                                               // BTR-60PB
    "PRACS_SLA_1S91",                                               // BTR-60PB
    "PRACS_SLA_SA17",                                                 // T-34-85M
    "PRACS_SLA_Ural_ZPU4",                                                 // T55A
    "PRACS_SLA_1S91",                                                // BMP-2
    "PRACS_SLA_SA13",                                               // BTR-60PB
    "PRACS_SLA_BTR80",                                                 // T-34-85M
    "PRACS_SLA_BTR80A",                                                 // T55A
    "PRACS_SLA_BTR60",                                                 // T55A
    "PRACS_SLA_T72B",                                               // T72B
    "PRACS_SLA_T72BV",                                               // T72B
    "PRACS_SLA_BRDM_HQ_PKT",                                              // ZSU-23-4V
    "PRACS_SLA_URAL_Zu23"                                               // ZSU-23-4V
];

// All enemy vehicles that can spawn as sector defenders and patrols but at a lower enemy combat readiness (aggression levels).
opfor_vehicles_low_intensity = [
    "PRACS_SLA_BRDM_HQ",                                        // Land Rover (M2)
    ...
    "PRACS_SLA_UAZ_open_DES",                                              // UAZ-3151 (DShKM)
    "PRACS_SLA_UAZ_AT_DES",                                              // UAZ-3151 (DShKM)
    "PRACS_SLA_Ural_AMB",                                          // Nissan (PKM)
    "LOP_ISTS_OPF_Nissan_PKM",                                          // Nissan (PKM)
    "PRACS_SLA_BTR40_AT_DES",                                                // BMP-1
    "LOP_ISTS_OPF_BMP1",                                                // BMP-1
    "PRACS_SLA_BMD2",                                                // BMP-2
    "PRACS_SLA_BTR80"                                                // BTR-60PB
];
...
opfor_battlegroup_vehicles = [
    ...
    "PRACS_SLA_BRDM_HQ_PKT",                                              // ZSU-23-4V
    "PRACS_SLA_URAL_Zu23",                                               // ZSU-23-4V
    "PRACS_SLA_Mi17Sh",                                              // Mi-8MT (Cargo)
    "PRACS_SLA_Mi24D",                                                 // Mi-24V (AT)
    "PRACS_SLA_Mi8amt",                                                // Mi-24V (FAB)
    "PRACS_SLA_Z11W_ATK2",                                              // Mi-8MT (Cargo)
    "PRACS_SLA_Z11W",                                                 // Mi-24V (AT)
    "PRACS_SLA_Z11W_ATK",                                                // Mi-24V (FAB)
    "PRACS_SLA_Z11W_B2",                                              // Mi-8MT (Cargo)
    "PRACS_SLA_Z11W_B",                                                 // Mi-24V (AT)
    "PRACS_SLA_Mi8_AMB",                                                // Mi-24V (FAB)
    "RHS_Su25SM_vvsc",                                                  // Su-25
    "PRACS_AN12B",                                                  // Su-25
    "PRACS_SLA_MiG21",                                                  // Su-25
    "PRACS_SLA_MiG23",                                                  // Su-25
    "PRACS_SLA_MiG27",                                                  // Su-25
    "PRACS_SLA_MIG28",                                                  // Su-25
    "PRACS_SLA_MiG29",                                                  // Su-25
